...
public interface UserService {
    ...
    /**
     * Checks if a user exists by their UUID (preferred over username).
     * @param uuid
    ...
    /**
     * Checks if a user exists in the cache by their UUID (preferred over username).
     * @param uuid
    ...
    /**
     * Remove the time to live from a user in the cache by their UUID (preferred over username).
     * @param uuid
    ...
    /**
     * Set the time to live of a user in the cache by their UUID (preferred over username).
     * @param uuid
     * @param seconds
